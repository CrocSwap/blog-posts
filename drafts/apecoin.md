...
Although most ApeCoin trading volume occurred on centralized exchanges such as FTX and Binance, a considerable amount also occurred on-chain, primarily via Uniswap on Ethereum mainnet. In this post, we report the results of a rudimentary analysis of the first 24 hours of on-chain trading data with a focus on liquidity providers' profits. Liquidity providers on Uniswap V3 derive revenue from collection of trading fees (a fixed percent of all swap volume); however, as prices fluctuate, they also suffer from impermanent loss (IL), a phenomenon in AMMs wherein the pool rebalances in the "wrong" direction realtive to price moves. Whether liquidity providers are in profit *relative to a portfolio where they hold the paired assets directly* therefore depends on the balance between trading fees and impermanent loss.

<<<<<<< HEAD:drafts/apecoin.md
...
=======
We show that although over 86% of ApeCoin liquidity positions on Uniswap V3 were in profits compared to their opening invested balances, the majority of liquidity positions incurred impermanent losses that outweighed their accumulated trading fees, suggesting that the typical liquidity provider would have been better off simply holding APE directly. Our results suggest that liquidity providers systematically underestimated the volatility of ApeCoin prices, leading them to undersize their position ranges and leading to substantial levels of impermanent loss.
>>>>>>> e6dce4f01687cd3ca5b54457b631eee7277470f7:drafts/apetoken.md

## Initial observations

Immediately subsequent to the launch of ApeCoin on centralized exchanges, liquidity was initialized on Uniswap V3, first via the APE/ETH pool and then via the APE/USDC pool approximately an hour afterward. Initial prices spiked then dropped dramatically. After several hours around $8 per APE, the price began to steadily increase, reaching a high of over $16 by the end of the first 24 hours:
...
=======
Aside from some heightened volatility within the first hour of trading (likely due to severe lack of liquidity), the price of ApeCoin was been very consistent across both the APE/ETH and APE/USDC liquidity pools: not too surprising, as by default Uniswap will route swaps through multiple pools for the best execution. And even if not price dislocations in excess of swap fees will be brought back into line by arbitrageuers. 
>>>>>>> e6dce4f01687cd3ca5b54457b631eee7277470f7:drafts/apetoken.md

Notably, both the APE/ETH and APE/USDC liquidity pools on Uniswap charge 1% fees—- higher than the typical active pool (for example, ETH/LOOKS primarily trades at 0.3%), but not unprecedented (SHIB and other 'meme' tokens tend to have 1% fee tiers). Given the strong trading interest in ApeCoin, this was an appealing incentive for users to step in and add liquidity to reap elevated trading fees. Correspondingly, the number of open liquidity positions on Uniswap skyrocketed in the first 12 hours of trading, eventually plateauing at around 650 positions:
...
On average, liquidity positions were similarly sized across the two pools. As the plot of position sizes below illustrates, all liquidity positions were under $10 million. However, the distribution of position sizes is nevertheless quite broad, ranging from $100 positions or smaller all the way into the upper seven figures.
...
The median liquidity position loses 0.3% of its initial portfolio value due to impermanent loss. However, the distribution of such losses has a long right tail, and on *average* positions lost 9.4% of their initial principal to IL. (Although, of course, they likely gained much more from appreciation on their underlying ApeCoin exposure.) In the worst cases, some people experienced IL of 100% of their initial principal!
...
=======
Did accrued trading fees sufficiently compensate for the severity of impermanent loss? To answer, we derived basic estimates of the trading fees realized across each liquidity position. Within each 10-minute interval, we tabulated the liquidity positions which were open and in range, as well as the total swap volume inside that interval. To simplify, we approximated that trading fees (1% of volume) are distributed proportionally across all active liquidity positions proportional to market value.
>>>>>>> e6dce4f01687cd3ca5b54457b631eee7277470f7:drafts/apetoken.md

![](./img/ape_fees.png)

As we can see, depending on position size and duration, trading fees earned were often as high as tens of thousands of dollars. Dividing fees accrued by a liquidity position's initial market value, we see that fees collected were, on average, not sufficient to fully compensate for impermanent loss:
